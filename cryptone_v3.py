    ...
    def evaluate(
        ...
        if trend == "BULLISH":
            ...
            sig = self._evaluate_side(
                ...
                direction="long", streak_color="red",
            )
            if sig is not None:
                return sig
            ...
            return self._evaluate_side(
                ...
                direction="short", streak_color="green",
            )
        else:  # BEARISH
...
class CryptoneV3:
    ...
    def __init__(self, config: Optional[Config] = None):
        ...
        self.reversal_engine = ReversalEngine(self.context, self.config.reversal)
    ...
    async def scan(self):
        ...
        for symbol in symbols_to_score:
            ...
            candidate.reversal = self.reversal_engine.evaluate(candidate, ev_obj)
