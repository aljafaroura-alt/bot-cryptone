...
class ContextEngine:
    ...
    def _get_multi_horizon_context(self, symbol: str, timeframe: Optional[str] = None) -> Dict:
        ...
        return {'timeframe': timeframe, 'horizons': horizons, 'reconciled': reconciled}
    ...
    def format_event(event: Event) -> str:
        ...
        if event.macro_structure or event.setup_structure or event.market_context or event.horizon_context:
            ...
            if event.horizon_context:
                lines.append(f"HORIZON:        {TelegramFormatter._horizon_context_text(event.horizon_context)}")
            lines.append("")
