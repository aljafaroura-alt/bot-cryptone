# scanners/scanners_sniper.py - SNIPER SCAN (AUTO TRADING SIGNAL)
...
from scanners.scanners_cross_tag import _cross_tag
from scanners.scanners_sniper_config import get_adaptive_sniper_config_advanced
from scanners.scanners_regime_coin import is_market_chaos
from database import track_signal_entry
from config import state_lock, SNIPER_ALL_COIN, SNIPER_MODE, _sniper_auto_state, last_entry_time, _shutdown_event
from utils import get_wib, fmt_price
