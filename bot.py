...
def check_smc_alert():
    ...
    try:
        ...
        if _smc_volatile_mode:
            MIN_CONFIDENCE = 75  # Naik dari 72
            MIN_RR = 2.2  # Naik dari 2.1
            logger.info("[SMC_ALERT] Volatile mode ACTIVE")
        else:
            MIN_CONFIDENCE = 70  # Strict thresholds
            MIN_RR = 2.0
