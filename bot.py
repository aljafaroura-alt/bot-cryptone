...
def ultimate_predator_scan():
    ...
    try:
        ...
        for coin in coins:
            # ===== FILTER HARGA VALID =====
            # FIX: all_mids return string, harus cast ke float dulu sebelum compare
            try:
                price = float(all_mids.get(coin, 0) or 0)
            ...
            # FIX: turunin threshold 65 → 55 (65 terlalu ketat saat market sideways/ranging)
