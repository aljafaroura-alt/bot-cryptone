# ==========================================================
# HL TERMINAL BOT - CLEAN BUILD
# Reorganized & patched version
#
# Fixed:
# - Duplicate handlers
# - TEMEN MODE
...
def is_market_chaos(symbol):
    ...
    try:
        ...
        if change_pct > INSANE_PRICE_MOVE:
...
# ═══════════════════════════════════════════════════════════
# MARKET DATA HELPER
# ═══════════════════════════════════════════════════════════ — semua pakai openInterest
# ═══════════════════════════════════════════════════════════

# ═══════════════════════════════════════════════════════════
# MARKET DATA HELPER
# ═══════════════════════════════════════════════════════════ - semua fungsi HL di sini
...
def status(message):
    global TEMEN_MODE
    status_temen = "ON" if TEMEN_MODE else "OFF"
    teks = f"""
📊 <b>BOT STATUS</b>
━━━━━━━━━━━━━━━━━━
👥 <b>TEMEN MODE:</b> {status_temen}
🤖 <b>BOT UPTIME:</b> {int((time.time() - START_TIME)/3600)} jam
━━━━━━━━━━━━━━━━━━
"""
    ...
    try:
        ...
        def scan_one_token(asset_ctx):
            ...
            try:
                ...
                warning = ""
                if ob_delta > INSANE_DELTA_THRESHOLD and funding > 0.01 and bias == "LONG":
