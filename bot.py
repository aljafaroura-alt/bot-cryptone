...
def get_ob_delta(coin):
    ...
    if coin in _ob_cache and now - _ob_cache_time.get(coin, 0) < 15:
    ...
    try:
        ...
        # EMA smoothing alpha=0.3 — cegah sinyal flip terlalu cepat
        prev_ema = _ob_delta_ema.get(coin, raw_delta)
        smoothed = 0.3 * raw_delta + 0.7 * prev_ema
...
def entry(message):
    try:
        ...
        # Minimum gap 15 poin — cegah flip cepat antara LONG/SHORT
