...
_CVD_CACHE_TTL = 60       # 60 detik TTL untuk CVD cache
_oi_history_cache = {}
_oi_history_time = {}
_history_cache = {}
_history_cache_time = {}
        ...
        if alerts:
            ...
            for a in alerts[:3]:
                ...
                teks = (
                    ...
                    f"\U0001f4ca {a['alignment']}/{a.get('tf_total', 3)} TF align{extra_line}{spread_warn}\n"
    ...
    try:
        ...
        for coin in top_coins:
            ...
            try:
                ...
                need_align = 3  # default
                if deriv_score >= 85:
                    need_align = 2  # Score tinggi, cukup 2/3 TF
...
def status_cmd(message):
    ...
    # ===== PREDATOR STATUS =====
    predator_text = "✅ ON (tiap 60 menit)" if _last_predator_scan > 0 else "🟡 IDLE"
...
def run_scheduler():
    ...
    while True:
        try:
            ...
            if now - _last_predator_scan >= 3600:
