...
schedule_jobs = {}  # {chat_id: [list_of_jobs]}
OI_HISTORY = {}

# ========== LIQUIDATION SCANNER GLOBALS ==========
_liq_scanner_running = False
_liq_last_oi = {}
_liq_last_volume = {}
_liq_last_notif = {}

# ========== CONFLUENCE SCANNER GLOBALS ==========
    ...
    try:
        ...
        for coin in COINS[:30]:
            try:
                ...
                elif d['funding'] > 0.01 and d['ob_delta'] > 50:
...
def set_schedule(message):
    ...
    try:
        ...
        if mode == 'insane':
            ...
            schedule_jobs[chat_id].append(job)
            bot.reply_to(message, f"✅ <b>INSANE RADAR ON</b>\nTiap {interval} menit scan.", parse_mode='HTML')
        elif mode == 'temen':
            ...
            schedule_jobs[chat_id].append(job)
            bot.reply_to(message, f"😊 <b>MOOD MODE ON</b>\nTiap {interval} menit gw kirim mood pasar.", parse_mode='HTML')
        else:
            bot.reply_to(message, "❌ Mode ga ada. Pake: insane | temen | mood", parse_mode='HTML')
...
CONFLUENCE_CONFIG = {
    ...
    "min_funding": -0.03,
    "max_funding": 0.03,
    "min_price_change_1h": 2,
    "max_price_change_1h": 10,
    "min_volume_spike": 2,
    "max_volume_spike": 15,
    "min_ob_delta_long": 10,
    "min_ob_delta_short": -10,
    "zone_timeframe": "4h",
    "fvg_timeframe": "1h",
    "scan_interval": 5,
}
